        ...
        <div className="salary-slip-preview-container">
          ...
          >
            ...
            <div style={{ 
              ...
              <div>
                <p style={{ fontSize: '12px', margin: '0 0 10px 0' }}>This is a computer-generated document. No signature required.</p>
                <p style={{ fontSize: '12px', margin: '0' }}>For any queries, please contact HR Department.</p>
              </div>
              <div style={{ 
                display: 'flex', 
